...
function SvgAddressCardSolid(props) {
  return (
    <svg
      aria-hidden="true"
      data-prefix="fas"
      data-icon="address-card"
      className="address-card-solid_svg__svg-inline--fa address-card-solid_svg__fa-address-card address-card-solid_svg__fa-w-18"
